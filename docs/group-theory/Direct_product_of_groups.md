# 群の直積
$G_1, G_2$ を群とする. $G_1$ を $g_1\in G_1$ に対して $(g_1,1_{G_2})$ のように書くと, 単位元 $(1_{G_1}, 1_{G_2})\in G_1\times G_2$ と逆元 $(g_1^{-1},1_{G_2})$ があり, 任意の $a,b\in G_1$ に対して, $(a,1_{G_2})(b,1_{G_2})=(ab,1_{G_2})$ で積に対して閉じているので, $G_1$ は直積 $G_1\times G_2$ の部分群とみなせる. $G_2$ についても同様である.
