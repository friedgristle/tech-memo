...
\begin{proof}
	...
	$y+m\mathbb{Z}=x+m\mathbb{Z}$, また同様に$n\mid (x-y)$でもあるので
	$y+n\mathbb{Z}=x+n\mathbb{Z}$となる.
	...
	$\mathbb{Z}/m\mathbb{Z}\times \mathbb{Z}/n\mathbb{Z}$の単位元は
	$(0+m\mathbb{Z}, 0+n\mathbb{Z})$で,
	$(k+m\mathbb{Z},k+n\mathbb{Z})=(0+m\mathbb{Z},0+n\mathbb{Z})$
	となるためには$m\mid k$かつ$n\mid k$であるが,
	$m,n$は互いに素なので, $k=0$である. 
	したがって$\mathrm{Ker}\phi = \{0+mn\mathbb{Z}\}$
	となるため, $\phi$は単射である.
